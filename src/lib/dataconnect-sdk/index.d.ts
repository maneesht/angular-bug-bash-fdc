...
/* Allow users to create refs without passing in DataConnect */
export function noArgsRef(vars?: NoArgsVariables): MutationRef<NoArgsData, NoArgsVariables>;
/* Allow users to pass in custom DataConnect instances */
export function noArgsRef(dc: DataConnect, vars?: NoArgsVariables): MutationRef<NoArgsData, NoArgsVariables>;

export function noArgs(vars?: NoArgsVariables): MutationPromise<NoArgsData, NoArgsVariables>;
export function noArgs(dc: DataConnect, vars?: NoArgsVariables): MutationPromise<NoArgsData, NoArgsVariables>;
