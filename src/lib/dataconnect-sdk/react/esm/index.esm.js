import { upsertUserRef, addFavoritedMovieRef, deleteFavoritedMovieRef, addReviewRef, updateReviewRef, deleteReviewRef, noArgsRef, listMoviesRef, getMovieByIdRef, getActorByIdRef, getCurrentUserRef, getIfFavoritedMovieRef, searchAllRef, connectorConfig } from '../../esm/index.esm.js';
...
export function useNoArgs(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options, false);
  function refFactory(vars) {
